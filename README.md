...
### Simple example:
```rust
use atlas::{completion::Prompt, providers::openai};
...
You can find more examples each crate's `examples` (ie. [`atlas-core/examples`](./atlas-core/examples)) directory. More detailed use cases walkthroughs are regularly published on our [Dev.to Blog](https://dev.to/0thtachi) and added to Atlas's official documentation [(docs.atlas.rs)](http://docs.atlas.rs).
...
- MongoDB vector store: [`atlas-mongodb`](https://github.com/AtlasPathways/AtlasPathwaysAI/tree/main/atlas-mongodb)
- LanceDB vector store: [`atlas-lancedb`](https://github.com/AtlasPathways/AtlasPathwaysAI/tree/main/atlas-lancedb)
- Neo4j vector store: [`atlas-neo4j`](https://github.com/AtlasPathways/AtlasPathwaysAI/tree/main/atlas-neo4j)
